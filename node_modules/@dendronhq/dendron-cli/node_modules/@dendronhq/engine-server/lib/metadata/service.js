...
class MetadataService {
    ...
    setFirstLookupTime() {
        return this.setMeta("firstLookupTime", common_all_1.Time.now().toSeconds());
    }
    setLastLookupTime() {
        return this.setMeta("lastLookupTime", common_all_1.Time.now().toSeconds());
    }
    setInactiveUserMsgSendTime() {
        return this.setMeta("inactiveUserMsgSendTime", common_all_1.Time.now().toSeconds());
    }
}
