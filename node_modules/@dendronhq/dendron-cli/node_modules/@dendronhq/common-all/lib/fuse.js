...
exports.NoteLookupUtils = exports.FuseEngine = exports.getCleanThresholdValue = exports.createSerializedFuseNoteIndex = exports.createFuseNote = exports.FuseExtendedSearchConstants = void 0;
...
class FuseEngine {
    ...
    static sortResults({ results, originalQS, }) {
        ...
        let sorted = lodash_1.default.orderBy(results.map((res) => ({
            ...res,
...
class NoteLookupUtils {
    static async lookup({ qs, originalQS, engine, showDirectChildrenOnly, }) {
        const { notes } = engine;
