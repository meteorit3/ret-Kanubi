...
class PublishCLICommand extends base_1.CLICommand {
    ...
    async _buildNextData({ wsRoot, stage, dest, attach, overrides, }) {
        ...
        if (stage !== "prod") {
            if (!opts.engine.config.site.siteUrl && !(overrides === null || overrides === void 0 ? void 0 : overrides.siteUrl)) {
                lodash_1.default.set(opts.config.overrides, "siteUrl", "localhost:3000");
            }
        }
        const { error } = engine_server_1.SiteUtils.validateConfig(opts.engine.config.site);
        if (error) {
            return { error };
        }
