import { IntermediateDendronConfig, DendronSiteConfig, DEngineClient, NoteProps, NotePropsDict } from "@dendronhq/common-all";
...
export declare const removeBodyFromNotesDict: (notes: NotePropsDict) => {
    [k: string]: any;
};
