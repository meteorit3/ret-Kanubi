...
export declare class GithubIssueImportPod extends ImportPod<GithubIssueImportPodConfig> {
     ...
     */
    getNewNotes(notes: NoteProps[], engine: DEngineClient, wsRoot: string, vault: DVault): NoteProps[];
    /**
     * method to update the notes whose status has changed
     */
    getUpdatedNotes(notes: NoteProps[], engine: DEngineClient, wsRoot: string, vault: DVault): NoteProps[];
