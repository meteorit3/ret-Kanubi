...
class PodUtils {
    ...
    static async refreshGoogleAccessToken(wsRoot, refreshToken, connectionId) {
        const port = fs_extra_1.default.readFileSync(path_1.default.join(wsRoot, ".dendron.port"), {
            encoding: "utf8",
        });
        try {
