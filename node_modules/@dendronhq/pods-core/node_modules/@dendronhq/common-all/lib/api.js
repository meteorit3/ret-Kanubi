...
class API {
    ...
    async _makeRequest(args, payloadData) {
        ...
        try {
            ...
            payload.error = ((_b = (_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || err;
        }
        if (payload.error) {
            this._log(payload.error, "error");
        }
