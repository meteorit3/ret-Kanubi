...
class MDUtilsV5 {
            ...
            case ProcMode.FULL:
                {
                    ...
                    if (opts.flavor === common_all_1.ProcFlavor.PUBLISHING) {
                        const prefix = ((_a = data.config) === null || _a === void 0 ? void 0 : _a.site.assetsPrefix)
                            ? ((_b = data.config) === null || _b === void 0 ? void 0 : _b.site.assetsPrefix) + "/notes/"
                            : "/notes/";
                        proc = proc.use(dendronPub_1.dendronPub, {
                            wikiLinkOpts: {
                                prefix,
    ...
    static _procRehype(opts, data) {
        ...
        const enableKatex = MDUtilsV5.shouldApplyPublishingRules(pRehype)
            ? common_all_1.ConfigUtils.getProp(config, "useKatex")
            : common_all_1.ConfigUtils.getPreview(config).enableKatex;
        if (enableKatex) {
