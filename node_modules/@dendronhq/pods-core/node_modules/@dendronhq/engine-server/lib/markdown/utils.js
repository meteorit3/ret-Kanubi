...
exports.PublishUtils = exports.MdastUtils = exports.MDUtilsV4 = exports.renderFromNote = exports.renderFromNoteProps = void 0;
...
const renderFromNoteProps = (opts) => {
    ...
    return (0, exports.renderFromNote)({ note });
};
...
class MDUtilsV4 {
    ...
    static procHTML(procOpts) {
        ...
        let proc = MDUtilsV4.procFull({
            ...
            publishOpts: {
                assetsPrefix: (0, common_all_1.getStage)() === "prod" ? config.site.assetsPrefix : undefined,
