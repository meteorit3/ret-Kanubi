...
export declare const ENABLE_NUNJUCKS: (namespace: TopLevelDendronConfig) => DendronConfigEntry;
...
export declare const ENABLE_HIERARCHY_DISPLAY: (namespace: TopLevelDendronConfig) => DendronConfigEntry;
export declare const HIERARCHY_DISPLAY_TITLE: (namespace: TopLevelDendronConfig) => DendronConfigEntry;
