...
exports.PUBLISHING = {
    enableFMTitle: global_1.ENABLE_FM_TITLE("publishing"),
    enableHierarchyDisplay: global_1.ENABLE_HIERARCHY_DISPLAY("publishing"),
    hierarchyDisplayTitle: global_1.HIERARCHY_DISPLAY_TITLE("publishing"),
    enableNoteTitleForLink: global_1.ENABLE_NOTE_TITLE_FOR_LINK("publishing"),
    enableMermaid: global_1.ENABLE_MERMAID("publishing"),
    enableNunjucks: global_1.ENABLE_NUNJUCKS("publishing"),
    enablePrettyRefs: global_1.ENABLE_PRETTY_REFS("publishing"),
    enableKatex: global_1.ENABLE_KATEX("publishing"),
    assetsPrefix: {
        label: "Assets Prefix",
