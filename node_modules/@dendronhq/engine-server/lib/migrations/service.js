...
class MigrationServce {
    static async applyMigrationRules({ currentVersion, previousVersion, migrations, wsService, ...rest }) {
        ...
        const logger = common_server_1.createLogger("migration");
        logger.info({
    ...
    static async applyMigrationChanges({ previousVersion, migration, wsService, logger, ...rest }) {
        const results = [];
