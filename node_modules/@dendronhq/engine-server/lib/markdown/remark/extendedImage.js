...
function attachParser(proc) {
    ...
    function inlineTokenizer(eat, value) {
        ...
        if (match && ((_a = match.groups) === null || _a === void 0 ? void 0 : _a.url)) {
            let props = {};
            try {
                props = yamljs_1.default.parse(match.groups.props);
            }
            catch {
        ...
        visitors.extendedImage = function (node) {
            ...
            switch (dest) {
                case types_1.DendronASTDest.MD_DENDRON:
                    return `![${alt}](${node.url})${yamljs_1.default.stringify(node.props, 0 /* Inline-only so we get JSON style {foo: bar} */)}`;
...
function extendedImage2html(node, opts) {
    return mdast_builder_1.html(extendedImage2htmlRaw(node, opts));
}
