...
class SeedService {
    ...
    async addSeedMetadata({ seed, wsRoot, onUpdatingWorkspace, onUpdatedWorkspace, }) {
        ...
        const updateWorkspace = workspace_1.WorkspaceUtils.getWorkspaceTypeFromDir(wsRoot) === common_all_1.WorkspaceType.CODE;
        await ws.addVault({
    ...
    async removeSeedMetadata({ seed, onUpdatingWorkspace, onUpdatedWorkspace, }) {
        ...
        common_all_1.ConfigUtils.setWorkspaceProp(config, "seeds", seeds);
        ws.setConfig(config);
        const updateWorkspace = workspace_1.WorkspaceUtils.getWorkspaceTypeFromDir(this.wsRoot) ===
