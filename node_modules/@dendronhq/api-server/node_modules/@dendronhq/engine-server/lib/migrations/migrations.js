...
exports.ALL_MIGRATIONS = exports.CONFIG_MIGRATIONS = void 0;
    ...
    changes: [
        {
            ...
            func: async ({ dendronConfig, wsConfig, wsService }) => {
                 ...
                 */
                const backupPath = config_1.DConfig.createBackup(wsService.wsRoot, "migrate-configs");
                ...
                const defaultV4Config = common_all_1.ConfigUtils.genDefaultConfig();
                ...
                utils_2.PATH_MAP.forEach((value, key) => {
                    ...
                    if (iteratee !== "skip") {
                        ...
                        if (lodash_1.default.isUndefined(maybeLegacyConfig)) {
                            ...
                            valueToFill = lodash_1.default.get(defaultV4Config, key);
                        }
                        else {
                ...
                // set config version.
                lodash_1.default.set(cleanDendronConfig, "version", 4);
                ...
                const migratedConfig = lodash_1.default.defaultsDeep(cleanDendronConfig, defaultV4Config);
