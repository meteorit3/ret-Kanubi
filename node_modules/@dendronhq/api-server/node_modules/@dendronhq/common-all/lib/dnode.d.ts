...
import { DEngineClient, DLink, DNodeOpts, DNodeProps, DNodePropsDict, DNodePropsQuickInputV2, DNoteLoc, DVault, NoteLocalConfig, NoteOpts, NoteProps, NotePropsDict, SchemaModuleDict, SchemaModuleOpts, SchemaModuleProps, SchemaOpts, SchemaProps, SchemaPropsDict, SchemaRaw } from "./types";
/**
...
export declare class NoteUtils {
    ...
    static getNoteLocalConfig(note: NoteProps): Partial<{
        global: Partial<Pick<import("./types").DendronGlobalConfig, "enableChildLinks" | "enablePrettyRefs">>;
    }>;
    ...
    static hydrate({ noteRaw, noteHydrated, }: {
        ...
        traits?: import("./types").NoteTrait[] | undefined;
    };
    ...
    static serializeExplicitProps(props: NoteProps): any;
